...
_0x4:
	.DB  0x1
_0x2F:
	.DB  0x7,0x0,0x2,0x0,0x0,0x0,0x0,0x0
	.DB  0x0,0x0
_0x0:
	.DB  0x2A,0x0,0x5D,0x0,0x5B,0x0,0x70,0x6C
	.DB  0x61,0x79,0x65,0x72,0x20,0x32,0x20,0x77
	.DB  0x69,0x6E,0x73,0x0,0x70,0x6C,0x61,0x79
	.DB  0x65,0x72,0x20,0x31,0x20,0x77,0x69,0x6E
	.DB  0x73,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 00F7       PIND.7=-1;
; 0000 00F8       print(player2_score);*/
; 0000 00F9       ///////////////////
; 0000 00FA       lcd_gotoxy(ball_x,ball_y);
	ST   -Y,R4
	MOV  R26,R6
	RCALL _lcd_gotoxy
; 0000 00FB           lcd_puts("*");
	__POINTW2MN _0x1F,0
	RCALL _lcd_puts
; 0000 00FC           lcd_gotoxy(0,player1_y);
	LDI  R30,LOW(0)
	ST   -Y,R30
	MOV  R26,R8
	RCALL _lcd_gotoxy
; 0000 00FD           lcd_puts("]");
	__POINTW2MN _0x1F,2
	RCALL _lcd_puts
; 0000 00FE           lcd_gotoxy(15,player2_y);
	LDI  R30,LOW(15)
	ST   -Y,R30
	MOV  R26,R10
	RCALL _lcd_gotoxy
...
; 0000 010F             bool_x=1;
	RCALL SUBOPT_0x3
; 0000 0110           if(player1_y!=ball_y){
	__CPWRR 6,7,8,9
	BREQ _0x27
; 0000 0111             player1_y=0;
	RCALL SUBOPT_0x4
; 0000 0112             player2_y=0;
; 0000 0113             ball_x=7;
; 0000 0114             ball_y=2;
; 0000 0115             bool_x=1;
; 0000 0116             bool_y=1;
	RCALL SUBOPT_0x2
; 0000 0117             player2_score++;
	LDI  R26,LOW(_player2_score)
	LDI  R27,HIGH(_player2_score)
	LD   R30,X+
	LD   R31,X+
	ADIW R30,1
	ST   -X,R31
...
; 0000 0118             lcd_clear();
	RCALL _lcd_clear
; 0000 0119             lcd_puts("player 2 wins");
	__POINTW2MN _0x1F,6
	RCALL SUBOPT_0x1
...
; 0000 011E             bool_x=0;
	...
	STS  _bool_x,R30
	STS  _bool_x+1,R30
; 0000 011F           if(player2_y!=ball_y){
	__CPWRR 6,7,10,11
	BREQ _0x29
; 0000 0120             player1_y=0;
	RCALL SUBOPT_0x4
; 0000 0121             player2_y=0;
; 0000 0122             ball_x=7;
; 0000 0123             ball_y=2;
; 0000 0124             bool_x=1;
; 0000 0125             bool_y=1;
	RCALL SUBOPT_0x2
; 0000 0126             player1_score++;
	MOVW R30,R12
	ADIW R30,1
	MOVW R12,R30
; 0000 0127             lcd_clear();
	RCALL _lcd_clear
; 0000 0128             lcd_puts("player 1 wins");
	__POINTW2MN _0x1F,20
	RCALL SUBOPT_0x1
